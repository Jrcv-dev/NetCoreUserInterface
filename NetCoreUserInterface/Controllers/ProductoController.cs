...
namespace NetCoreUserInterface.Controllers
{
    public class ProductoController : Controller
    {
        ...
        string pathController = "api/products";
        ...
        public ActionResult Details(int id)
        {
            ...
            var resultadoFinal = Api.ProductsApiDetails(id, Baseurl, pathController);
            ViewData["username"] = ses.GetSession("SessionUser");
            ViewData["rol"] = ses.GetSession("UserRol");
        ...
        public ActionResult Create(Producto model)
        {
            try
            {
                var resultadoFinal = Api.createProduct(Baseurl, pathController, model);
        ...
        public ActionResult Delete(int id)
        {
          /*  try
            {*/
                ...
                var resultadoFinal = Api.DeleteProduct(Baseurl, pathController, id);

                ViewData["username"] = ses.GetSession("SessionUser");
                ViewData["rol"] = ses.GetSession("UserRole");
                return RedirectToAction("Todos", "Producto", new { id = 1 });
           // }
            //catch
            //{
